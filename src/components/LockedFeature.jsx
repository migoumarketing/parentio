export default function LockedFeature({
  ...
  return (
    <div style={{ padding: 16, borderRadius: 16, background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.22)", color: "#f59e0b", fontSize: 13, fontWeight: 700, lineHeight: 1.5 }}>
      ...
      <button onClick={onUpgrade} style={{ border: "none", borderRadius: 12, padding: "11px 14px", background: "#f59e0b", color: "#111827", fontWeight: 900, cursor: "pointer" }}>{buttonLabel}</button>
    </div>
  );
}
