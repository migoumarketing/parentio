...
export default function App() {
  ...
  const {
    ...
    onEventsChange: () => console.log("Events sync"),
    onNotesChange: () => console.log("Notes sync"),
    onCoparentsChange: () => console.log("Coparents sync")
  });
