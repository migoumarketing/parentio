...
function translateVisibleText(value, lang) {
  ...
  const replacements = {
    tx(currentLang, "nextVacations"): dict.nextVacations,
    tx(currentLang, "nextSpecialDays"): dict.nextSpecialDays,
    tx(currentLang, "summer"): dict.summer,
    tx(currentLang, "motherDay"): dict.motherDay,
    tx(currentLang, "fatherDay"): dict.fatherDay,
    tx(currentLang, "nationalDay"): dict.nationalDay,
    tx(currentLang, "assumption"): dict.assumption,
    tx(currentLang, "allSaints"): dict.allSaints,
    tx(currentLang, "armistice"): dict.armistice,
    tx(currentLang, "shared"): dict.shared,
    tx(currentLang, "emergencyContacts"): dict.emergencyContacts,
    tx(currentLang, "name"): dict.name,
    tx(currentLang, "phone"): dict.phone,
    tx(currentLang, "addContact"): dict.addContact,
    "Juin": dict.june,
